<section class="hero">
    <div class="swiper heroSwiper min-h-fit h-screen max-h-[800px]" x-data="">
        <!-- slider items -->
            ...
            <?php for($item = 1; $item <= 4; $item++): ?>
                <div class="swiper-slide">
                    <div class="absolute inset-0 w-full h-full">
                        <!-- $item meni pouze obrazek, ignorovat -->
                        <img src="https://picsum.photos/2000/200<?php echo $item; ?>" class="object-cover object-center w-full h-full" alt="hero image">
                    </div>
                    <div class="container h-full relative z-10">
                        <div class="py-8 md:py-[70px] md:px-20 flex flex-col h-full justify-between gap-12">
        ...
        <div class="absolute top-8 md:top-auto md:bottom-12 w-full z-10">
            ...
            <div class="absolute left-1/2 -translate-x-1/2 bottom-0 hidden md:block">
